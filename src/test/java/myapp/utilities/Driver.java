...
public class Driver {
    ...
    4. Create a separate method for switch statement called initialiseDriver() and call that method in getDriver() to implement the same
    ...
    ;  // private Constructor => to prevent any external instantiation
